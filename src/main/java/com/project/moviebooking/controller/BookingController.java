...
public class BookingController {
    ...
    @GetMapping("/{tid}/{mid}")
    public List<ResponseEntity<Booking>> getBookings(@PathVariable("tid") Long theatreId,
    ...
    public List<ResponseEntity<Booking>> getBookingsByShowDate(@PathVariable("tid") Long theatreId,
                                                               @PathVariable("mid") Long movieId,
